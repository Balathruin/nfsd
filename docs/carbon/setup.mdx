...
**120 is the fastest framerate** to run the game at due to the in-game cutscenes playing faster and menu response time being the quickest. You can use [RivaTuner Statistics Server (RTSS)](https://www.guru3d.com/download/rtss-rivatuner-statistics-server-download/) or your graphics driver to limit your framerate. If you can’t run 120 with 1 core then I would consider lowering your fps to the next fastest.

<details>
<summary>Framerate comparison</summary>
