...
This is the fastest known route. Click the image for full resolution.

Complete the events marked with red before the additional steps.

Car tuning: 1 = left, 2 = middle, 3 = right

[![Career Any% NG Route Map](./img/ng_route.webp)](./img/ng_route.jpg)

### Mazda drifts

If you would like to use the Mazda instead of the Elise for a couple drifts, swap after Event 21.

### Camaro upgrades

If you are having a lot of trouble with the Camaro early on, you can swap the first two races and upgrade Nitrous 111 and Tires 2 after the sprint. This should make the Camaro easier to use at the cost of only a few seconds.
