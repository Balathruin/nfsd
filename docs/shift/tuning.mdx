...
An alternative method for minor or moderate balance adjustments. Rebounds are the safest to tweak. Default values are all slightly stiff in this game.
...
Tire Pressures are a great way to finetune car balance. Lower pressure in the rear can decrease oversteer and vice versa. Pressures also affect responsiveness - lower is slower, higher is faster.
