...
Preload - Stage 3: Lower settings make it more difficult for the differential to lock, resulting in more oversteer. The default and minimum setting is medium preload (60 Nm).
