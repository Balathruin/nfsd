...
Upgrading an existing turbo is always really weak as you only gain 1-5% power. The only exception is the Supra which has special highly effective turbo upgrades - Stage 2 is +25% and Stage 3 is +45%.
