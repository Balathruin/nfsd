...
Deadzones depend on your input device(s). Default (50%) Throttle and Brake Sensitivity recommended. With ABS off, lower Brake Sensitivity can be useful for finer control during corner entry (trail braking).
...
328 \* Physical Deadzone = Anti-Deadzone Buffer
  ...
  <TabItem value="ad33" label="33.3% Anti-Deadzone">
| Anti-Deadzone | Anti-Deadzone Buffer | Physical Deadzone |
|:-:|:-:|:-:|
| `10912` | `0` | 0% |
| `10748` | `328` | 1% |
...
10912 - (164 \* Physical Deadzone) = Anti-Deadzone

328 \* Physical Deadzone = Anti-Deadzone Buffer
  </TabItem>
  <TabItem value="ad25" label="25% Anti-Deadzone">
| Anti-Deadzone | Anti-Deadzone Buffer | Physical Deadzone |
|:-:|:-:|:-:|
| `8192` | `0` | 0% |
| `8028` | `328` | 1% |
...
8192 - (164 \* Physical Deadzone) = Anti-Deadzone

328 \* Physical Deadzone = Anti-Deadzone Buffer
  </TabItem>
  <TabItem value="curve" label="Custom Response Curve">
An alternative to adjusting anti-deadzone is using a custom response curve. This method doesn't play well if your controller requires deadzone.

Select *Custom Curve* in Stick Response Curve.

| Custom Response Curve | Translated Output at 10% Physical Position
|:-:|:-:|
| 325 | ~50% |
| 320 | ~40% |
| **316** | **~33%** |
...
My settings: 316 Response Curve and 2 Dead Zone in Steam Input; 0% Steering Deadzone, 25% Steering Sensitivity and 85% Speed Sensitivity in-game
  </TabItem>
</Tabs>

<details>

<summary>50% Anti-Deadzone with 2% Physical Deadzone</summary>
